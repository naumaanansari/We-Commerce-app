      ...
      <div className="bg-white mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 mt-12 ">
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          ...
          <button
            ...
            type="submit"
            className="rounded-md bg-green-600 my-2 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
          >
            Add New Address
          </button>
          {showAddAddressForm ? (
